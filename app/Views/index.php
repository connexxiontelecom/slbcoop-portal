                        ...
                        <div class="nk-wg7">
                          ...
                          <div class="nk-wg7-stats-group">
                            ...
                            <div class="nk-wg7-stats w-100">
                              ...
                              <div class="number"><em
                                  class="icon ni ni-sign-kobo"></em><?= number_format($regular_savings - $encumbered_amount,
                                    2) ?>
                              </div>
                            </div>
                          </div>
              ...
              <div class="col-md-6">
                <div class="card-head">
                  <div class="card-title mb-0 d-flex justify-content-between w-100">
                    ...
                    <span
                      class="number-sm currency currency-usd">
                      &#8358; <?= number_format($total_outstanding, 2) ?> Total</span>
                  </div>
                </div><!-- .card-head -->
