        ...
        <div class="container-xl wide-lg">
          <div class="nk-block-head">
            <div class="nk-block-head-sub mb-3">
              <img class="logo-dark logo-img mr-1" src="/assets/images/slbcoop-logo.jpeg" alt="logo-dark">
            ...
            <div class="nk-block-between-md g-4">
              ...
              <div class="nk-block-head-content">
                <ul class="nk-block-tools gx-3">
                  <li><a href="/withdrawal-application" class="btn btn-primary"><span>New Withdrawal</span> <em
                        class="icon ni ni-arrow-long-right"></em></a></li>
                  <li><a href="/loan-application" class="btn btn-white btn-light"><span>New Loan</span> <em
                        ...
                        <div class="nk-wg7">
                          ...
                          <div class="nk-wg7-stats-group">
                            <div class="nk-wg7-stats w-100">
                              ...
                              <div class="number"><em
                                  class="icon ni ni-sign-kobo"></em> <?= number_format($encumbered_amount, 2) ?></div>
                            </div>
                            <div class="nk-wg7-stats w-100">
                ...
                <div class="nk-block">
                  <div class="nk-block-head-xs">
                    <div class="nk-block-between-md g-2">
                      ...
                      <div class="nk-block-head-content">
                        <a href="/account-statement" class="link link-primary">Account Statement</a>
                      </div>
                    </div>
                  </div><!-- .nk-block-head -->
                  <div class="row g-2">
                        ...
                        <div class="nk-wgw sm">
                          <a class="nk-wgw-inner" href="#">
                            ...
                            <div class="nk-wgw-balance">
                              <div class="amount"><?= $pending_withdrawals ?><span class="currency currency-nio"> pending</span>
                              </div>
                            </div>
                          </a>
                        </div>
                      ...
                      <div class="card bg-light">
                        <div class="nk-wgw sm">
                          <a class="nk-wgw-inner" href="#">
                            ...
                            <div class="nk-wgw-balance">
                              <div class="amount"><?= $approved_withdrawals ?><span class="currency currency-btc"> approved</span>
                              </div>
                            </div>
                          </a>
                        </div>
                      ...
                      <div class="card bg-light">
                        <div class="nk-wgw sm">
                          <a class="nk-wgw-inner" href="#">
                            ...
                            <div class="nk-wgw-balance">
                              <div class="amount"><?= $disbursed_withdrawals ?><span class="currency currency-eth"> disbursed</span>
                              </div>
                            </div>
                          </a>
                        </div>
                          ...
                          <a class="nk-wgw-inner" href="#">
                            ...
                            <div class="nk-wgw-balance">
                              <div class="amount"><?= $pending_loans ?><span
                                  class="currency currency-nio"> pending</span></div>
                            </div>
                          </a>
                        </div>
                      </div>
                          ...
                          <a class="nk-wgw-inner" href="#">
                            ...
                            <div class="nk-wgw-balance">
                              <div class="amount"><?= $approved_loans ?><span
                                  class="currency currency-btc"> approved</span></div>
                            </div>
                          </a>
                        </div>
                      </div>
                          ...
                          <a class="nk-wgw-inner" href="#">
                            ...
                            <div class="nk-wgw-balance">
                              <div class="amount"><?= $disbursed_loans ?><span
                                  class="currency currency-eth"> disbursed</span></div>
                            </div>
                          </a>
                        </div>
                      </div>
                    ...
                    <div class="tranx-item">
                      ...
                      <div class="tranx-col">
                        <div class="tranx-amount">
                          <div class="number">&#8358; <?= number_format($outstanding_loan['total_cr'], 2) ?> <span
                              class="currency currency-btc">Paid</span></div>
                          <div class="number-sm">&#8358; <?= number_format($outstanding_loan['loan_balance'], 2) ?>
                            <span
                ...
                <div class="align-center flex-wrap flex-md-nowrap g-4">
                  ...
                  <div class="nk-block-content">
                    <div class="nk-block-content-head px-lg-4">
                      ...
                      <p class="text-soft">Ask a question or file a support ticket, manage request, report an issues.
