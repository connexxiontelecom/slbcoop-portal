                              ...
                              <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                  <input type="number" class="form-control"
                                         id="loan-duration" name="loan_duration"
                                         required disabled>
                    ...
                    <div class="card card-preview">
                      <div class="card-inner">
                        ...
                        <div class="alert alert-icon alert-warning mt-1 mb-1" role="alert"
                          ...
                          <em class="icon ni ni-alert-circle"></em><span
                            class="font-weight-bolder">We're Sorry</span>.
                          You cannot apply for a Normal Loan with any other pending Normal Loan.
                        </div>
                        <!--loan duration-->
                        <div class="alert alert-icon alert-success mt-1 mb-1" role="alert"
